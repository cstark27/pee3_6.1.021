...
.method public static convertToGcamStaticMetadata(Lkvg;)Lcom/google/googlex/gcam/StaticMetadata;
	...
	#invoke-static {}, Lcom/custom/extras;->sP3M()I
	...
	#invoke-static {}, Lcom/custom/extras;->sP3D()I
	...
	sput v1, Lbti;->sd821:I
	
	const/4 v1, 0x0
	
	sput v1, Lbti;->sd835:I
	
	sput v1, Lbti;->sd845:I
...
.method private static getQcColorCalibration(Lkvg;)Lcom/google/googlex/gcam/QcColorCalibration;
    ...
    :try_start_0
    sget-object v0, Ljij;->A:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :cond_1
    :try_start_1
    sget-object v0, Ljij;->B:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v1, Ljij;->y:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v0, Ljij;->z:Landroid/hardware/camera2/CameraCharacteristics$Key;
...
.method private static oisMetadataFromExperimental(Lkyr;)Ljava/util/Optional;
    ...
    sget-object v0, Ljij;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v1, Ljij;->w:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v2, Ljij;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {p0, v2}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [F

    sget-object v3, Ljij;->t:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p0, v3}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :cond_4
    sget-object v2, Ljij;->u:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Ljij;->v:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public convertToGcamFrameMetadata(Lkyr;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    sget-object v0, Ljij;->c:Landroid/hardware/camera2/CaptureResult$Key;
