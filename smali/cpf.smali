...
.method static a()Z
    ...
    sget-object v0, Ljik;->d:Landroid/hardware/camera2/CaptureRequest$Key;

    if-eqz v0, :cond_0

    sget-object v0, Ljik;->a:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_0

    sget-object v0, Ljik;->b:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_0

    sget-object v0, Ljik;->c:Landroid/hardware/camera2/CaptureResult$Key;
