...
.method public constructor <init>(Lkyu;ILandroid/graphics/Rect;)V
    ...
    sget-object v2, Ljij;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v4, Ljij;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_3
    sget-object v2, Ljij;->x:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Ljij;->x:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v2, Ljik;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Ljik;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_b
    sget-object v2, Ljik;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Ljik;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {v6, v2}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    sget-object v3, Ljik;->g:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v6, v3}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, [B

    sget-object v4, Ljik;->h:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v6, v4}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, [F

    sget-object v5, Ljik;->f:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v6, v5}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, [F

    sget-object v8, Ljik;->i:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v6, v8}, Lkyr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    new-array v2, v0, [Lhmt;

    move-object/from16 v0, p0

    iput-object v2, v0, Lhmu;->h:[Lhmt;
    ...
    iget-object v3, v14, Lkys;->a:Landroid/hardware/camera2/params/Face;

    invoke-virtual {v3}, Landroid/hardware/camera2/params/Face;->getId()I

    move-result v3

    iget-object v4, v14, Lkys;->a:Landroid/hardware/camera2/params/Face;

    invoke-virtual {v4}, Landroid/hardware/camera2/params/Face;->getBounds()Landroid/graphics/Rect;

    move-result-object v4

    iget-object v5, v14, Lkys;->a:Landroid/hardware/camera2/params/Face;
    ...
    invoke-virtual {v14, v6}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v6

    const/4 v7, 0x2

    invoke-virtual {v14, v7}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v7

    const/4 v8, 0x4

    invoke-virtual {v14, v8}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v8

    const/4 v9, 0x3

    invoke-virtual {v14, v9}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v9

    const/4 v10, 0x5

    invoke-virtual {v14, v10}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v10

    const/4 v11, 0x6

    invoke-virtual {v14, v11}, Lkys;->a(B)Landroid/graphics/PointF;

    move-result-object v11

    iget v12, v14, Lkys;->d:F

    iget v13, v14, Lkys;->b:F

    iget v14, v14, Lkys;->c:F

    invoke-direct/range {v2 .. v14}, Lhmt;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V

    move-object/from16 v0, p0

    invoke-direct {v0, v2}, Lhmu;->a(Lhmt;)Lhmt;
    ...
    new-instance v11, Lkys;

    aget-object v13, v7, v8

    move-object/from16 v0, v17

    invoke-direct {v11, v13, v12, v14, v0}, Lkys;-><init>(Landroid/hardware/camera2/params/Face;[B[F[F)V
