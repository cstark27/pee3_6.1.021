...
.method private makeMessageLine(Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    :cond_0
    invoke-virtual {v2, v1}, Lix;->a(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2, v0}, Lix;->a(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public apply(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/Person;->toAndroidPerson()Landroid/app/Person;

    move-result-object v0

    invoke-direct {v4, v0}, Landroid/app/Notification$MessagingStyle;-><init>(Landroid/app/Person;)V
    ...
    invoke-virtual {v4, v0}, Landroid/app/Notification$MessagingStyle;->setConversationTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$MessagingStyle;
    ...
    invoke-virtual {v4, v0}, Landroid/app/Notification$MessagingStyle;->setGroupConversation(Z)Landroid/app/Notification$MessagingStyle;
    ...
    :goto_1
    invoke-direct {v3, v6, v8, v9, v1}, Landroid/app/Notification$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLandroid/app/Person;)V
    ...
    invoke-virtual {v1, v3, v0}, Landroid/app/Notification$MessagingStyle$Message;->setData(Ljava/lang/String;Landroid/net/Uri;)Landroid/app/Notification$MessagingStyle$Message;

    :cond_0
    invoke-virtual {v4, v1}, Landroid/app/Notification$MessagingStyle;->addMessage(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Notification$MessagingStyle;
    ...
    invoke-direct {v3, v6, v8, v9, v1}, Landroid/app/Notification$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLjava/lang/CharSequence;)V
